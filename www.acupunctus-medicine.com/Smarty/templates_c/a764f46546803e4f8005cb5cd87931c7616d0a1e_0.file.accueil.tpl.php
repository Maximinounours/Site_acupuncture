...
function content_603fb4fe620991_10259345 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
    <head>
...
?>
        ...
        <div id="tout">
            ...
            <div id="gauche" class="container">
                <a id="gauche1" class="noirci" href="register.html">
                Register</a>
                <a id="gauche2" class="noirci" href="connexion.html">Login</a>
            </div>
    
            <div id="droite" class="container">
                <a id="droite0" class="noirci" href="listeSymptome.html">Liste</a>
            </div>
